$(function() {
    var AppView = Backbone.View.extend({
        ...
        search: function(e) {
            ...
            this.albumsResults.fetch({
                success: function() {
                    that.albumsView.render();
                }
            });
        ...
        initialize: function() {
            ...
            this.tracksResults = new Backbone.Collection();
            this.albumsResults = new Backbone.Collection();
            this.artistsResults = new Backbone.Collection();

            this.tracksView = new TracksView({
                collection: this.tracksResults
            });
            this.albumsView = new AlbumsView({
                collection: this.albumsResults
            });
            this.artistsView = new ArtistsView({
                collection: this.artistsResults
            });
